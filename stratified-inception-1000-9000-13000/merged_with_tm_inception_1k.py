# -*- coding: utf-8 -*-
"""Merged- With TM - Inception - 1k.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ZZjvKgVuWMLyUXt9WI4borFzUgMvxAbF
...
model_nmf =  nmf.Nmf(corpus=corpus, num_topics=30, id2word=id2word, random_state=42)
...
# Create training and validation sets with topic modeling (for each topic ~80% (800) for train and 20% for test)
img_name_train_keys =[] 
img_name_val_keys = []
for i in range(30):
    ...
    slice_ind=int(len(image_paths)*0.814)
...
pd.DataFrame(bleus).to_csv('merged-bleus 1000.csv')
files.download('merged-bleus 1000.csv')

pd.DataFrame(pred).to_csv('merged-pred 1000.csv')
files.download('merged-pred 1000.csv')

from google.colab import files
df_dominant_topic.to_csv('1000wtopic.csv')
files.download('1000wtopic.csv')
