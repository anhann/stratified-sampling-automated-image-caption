# -*- coding: utf-8 -*-
"""Merged- With TM - Inception - 9k.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1O8PuEVxf_r_CX66lRUGHo7NkKeShEdLl
...
# Select the first 9000 image_paths from the shuffled set.
...
# Create training and validation sets with topic modeling (for each topic ~80% (7200) for train and 20% for test)
img_name_train_keys =[] 
img_name_val_keys = []
for i in range(30):
...
pd.DataFrame(bleus).to_csv('merged-bleus 9000.csv')
files.download('merged-bleus 9000.csv')

pd.DataFrame(pred).to_csv('merged-pred 9000.csv')
files.download('merged-pred 9000.csv')

from google.colab import files
df_dominant_topic.to_csv('9000wtopic.csv')
files.download('9000wtopic.csv')
