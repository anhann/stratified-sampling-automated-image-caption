# -*- coding: utf-8 -*-
"""Merged- With TM - Inception - 13k.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1q34z9U6EOc9F10mTE4F5lrX39xJ5YkUp
...
# Select the first 13000 image_paths from the shuffled set.
...
model_lda =  ldamodel.LdaModel(corpus=corpus, num_topics=50, id2word=id2word, random_state=42)
...
# Create training and validation sets with topic modeling (for each topic ~80% (10400) for train and 20% for test)
img_name_train_keys =[] 
img_name_val_keys = []
for i in range(50):
    ...
    slice_ind=int(len(image_paths)*0.80165)
...
pd.DataFrame(bleus).to_csv('merged-bleus 13000.csv')
files.download('merged-bleus 13000.csv')

pd.DataFrame(pred).to_csv('merged-pred 13000.csv')
files.download('merged-pred 13000.csv')

from google.colab import files
df_dominant_topic.to_csv('13000wtopic.csv')
files.download('13000wtopic.csv')
