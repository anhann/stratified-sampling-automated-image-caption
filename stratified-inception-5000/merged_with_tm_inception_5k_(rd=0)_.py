# -*- coding: utf-8 -*-
"""Merged- With TM - Inception - 5k (rd=0) .ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1c-e-MbZOpYAcb5gvHT7n8EWOailuzs76
...
# Create training and validation sets with topic modeling (for each topic ~80% for train (4000 image) and 20% for test)
img_name_train_keys =[]
img_name_val_keys = []
for i in range(30):
...
# save bleus, prediction and image with topics
from google.colab import files
pd.DataFrame(bleus).to_csv('merged-bleus 5000.csv')
files.download('merged-bleus 5000.csv')

pd.DataFrame(pred).to_csv('merged-pred 5000.csv')
files.download('merged-pred 5000.csv')

# topic
from google.colab import files
df_dominant_topic.to_csv('5000wtopic.csv')
files.download('5000wtopic.csv')
