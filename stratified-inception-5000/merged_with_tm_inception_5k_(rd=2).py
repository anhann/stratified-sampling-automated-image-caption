# -*- coding: utf-8 -*-
"""Merged- With TM - Inception - 5k (rd=2).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gSv0H3N4jjVPxNHAgss5ePD6Qs_017lf
...
# save bleus, prediction, topic
from google.colab import files
pd.DataFrame(bleus).to_csv('merged-bleus 5000 (rd2).csv')
files.download('merged-bleus 5000 (rd2).csv')

pd.DataFrame(pred).to_csv('merged-pred 5000 (rd2).csv')
files.download('merged-pred 5000 (rd2).csv')

# topic
from google.colab import files
df_dominant_topic.to_csv('5000wtopic (rd2).csv')
files.download('5000wtopic (rd2).csv')
