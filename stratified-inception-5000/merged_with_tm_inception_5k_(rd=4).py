# -*- coding: utf-8 -*-
"""Merged- With TM - Inception - 5k (rd=4).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_l5y_19-aejk8yBM2d6e0HHhNnIDXJU7
...
# Create training and validation sets with topic modeling (for each topic ~80% for train (4000) and 20% for test)
img_name_train_keys =[]
img_name_val_keys = []
for i in range(30):
...
len([i for i in bleus if i>0.7])/len(bleus)

len([i for i in bleus if i<0.3])/len(bleus)

len([i for i in bleus if i<0.5])/len(bleus)

max(bleus)

# save bleus prediction and topic
from google.colab import files
pd.DataFrame(bleus).to_csv('merged-bleus 5000 (rd4).csv')
files.download('merged-bleus 5000 (rd4).csv')

pd.DataFrame(pred).to_csv('merged-pred 5000 (rd4).csv')
files.download('merged-pred 5000 (rd4).csv')

# topic
from google.colab import files
df_dominant_topic.to_csv('5000wtopic (rd4).csv')
files.download('5000wtopic (rd4).csv')
