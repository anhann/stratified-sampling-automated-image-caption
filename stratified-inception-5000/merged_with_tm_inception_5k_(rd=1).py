# -*- coding: utf-8 -*-
"""Merged- With TM - Inception - 5k (rd=1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1OEg0MHcebxX2Jvll3zVUf3bpcXoqr6Od
...
for i in range(30):
    ...
    random.Random(1).shuffle(image_paths)
...
# save bleus, prediction and image with topic
from google.colab import files
pd.DataFrame(bleus).to_csv('merged-bleus 5000 (rd1).csv')
files.download('merged-bleus 5000 (rd1).csv')

pd.DataFrame(pred).to_csv('merged-pred 5000 (rd1).csv')
files.download('merged-pred 5000 (rd1).csv')

# topic
from google.colab import files
df_dominant_topic.to_csv('5000wtopic (rd1).csv')
files.download('5000wtopic (rd1).csv')
