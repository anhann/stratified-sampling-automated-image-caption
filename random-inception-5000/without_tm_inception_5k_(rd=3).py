# -*- coding: utf-8 -*-
"""Without TM - Inception - 5k (rd=3).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1VRpzxOiAE-lkT2dMto8PfzA7X-YCBA_e
...
"""## Split the data into training and testing (Random state =3)"""
...
random.Random(3).shuffle(img_keys)
...
pd.DataFrame(bleus2).to_csv('withoutTM-bleus (rd3).csv')
files.download('withoutTM-bleus (rd3).csv')

pd.DataFrame(pred2).to_csv('withoutTM-pred (rd3).csv')
files.download('withoutTM-pred (rd3).csv')
