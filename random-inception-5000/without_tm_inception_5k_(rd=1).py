# -*- coding: utf-8 -*-
"""Without TM - Inception - 5k (rd=1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_y-JtRnps7tHONG6SDpIWVwSZsbJ872G
...
"""## Split the data into training and testing (random_state=1)"""
...
random.Random(1).shuffle(img_keys)
...
pd.DataFrame(bleus2).to_csv('withoutTM-1.csv')
files.download('withoutTM-1.csv')

pd.DataFrame(pred2).to_csv('withoutTM-1pred.csv')
files.download('withoutTM-1pred.csv')
