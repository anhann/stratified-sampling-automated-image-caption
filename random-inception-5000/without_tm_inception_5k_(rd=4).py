# -*- coding: utf-8 -*-
"""Without TM - Inception - 5k (rd=4).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xqBGcAjVKqtQgGnsiuJylwww4vfwRe9B
...
"""## Split the data into training and testing (random_state = 4)"""
...
random.Random(4).shuffle(img_keys)
...
pd.DataFrame(bleus2).to_csv('withoutTM-bleus (rd4).csv')
files.download('withoutTM-bleus (rd4).csv')

pd.DataFrame(pred2).to_csv('withoutTM-pred (rd4).csv')
files.download('withoutTM-pred (rd4).csv')
