# -*- coding: utf-8 -*-
"""Merged - With TM - EfficientNetB7 - 5k (rd=0) - epoch=30 .ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jJkUJlIL9ffUFN_pJbJYYJ0vMh_K8Kl-
...
"""## Caching the features extracted from EfficientNatB7

You will pre-process each image with EfficientNetB7 and cache the output to disk. Caching the output in RAM would be faster but also memory intensive, requiring 18 \* 18 \* 2560 floats per image. At the time of writing, this exceeds the memory limitations of Colab (currently 12GB of memory).
...
* In this example, you extract the features from the lower convolutional layer of EfficientNetB7 giving us a vector of shape (18, 81, 2560).
