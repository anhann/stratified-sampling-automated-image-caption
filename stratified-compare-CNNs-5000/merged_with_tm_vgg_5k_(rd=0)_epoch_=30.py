# -*- coding: utf-8 -*-
"""Merged - With TM - VGG - 5k (rd=0) - epoch =30.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ljq8jOulIEvShUaTMpQBOAwNGEv0U3AB
...
This notebook is an end-to-end example. When you run the notebook, it downloads the [MS-COCO](http://cocodataset.org/#home) dataset, preprocesses and caches a subset of images using VGG16, trains an encoder-decoder model, and generates captions on new images using the trained model.
"""
...
"""## Preprocess the images using VGG-16
...
* In this example, you extract the features from the lower convolutional layer of VGG 16 giving us a vector of shape (7, 7, 512).
