# -*- coding: utf-8 -*-
"""Merged - With TM - EfficientNetB7 - 5k (rd=0) - epoch=20.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/10FvgeGoEDCf8X8uux8EO2XOnx3k1Kl3-
...
You will pre-process each image with EffNetB7 and cache the output to disk. Caching the output in RAM would be faster but also memory intensive, requiring  18\* 18 \* 2560 floats per image. 
...
# Shape of the vector extracted from EffNet is 324, 2560)
...
pd.DataFrame(bleus).to_csv('EffNet bleus.csv')
files.download('EffNet bleus.csv')

from google.colab import files
pd.DataFrame(pred).to_csv('EffNet pred.csv')
files.download('EffNet pred.csv')
