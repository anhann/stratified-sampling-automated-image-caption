# -*- coding: utf-8 -*-
"""Merged - With TM - VGG - 5k (rd=0) - LDA=30 epoch =100.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1zw4nGh3dZ5dWDT4eRLptvbhZl5T5m94L
...
This notebook is an end-to-end example. When you run the notebook, it downloads the [MS-COCO](http://cocodataset.org/#home) dataset, preprocesses and caches a subset of images using VGG-16, trains an encoder-decoder model, and generates captions on new images using the trained model.
"""
...
"""## Preprocess the images using VFF-16
...
"""## Initialize VGG-16 and load the pretrained Imagenet weights
...
"""## Caching the features extracted from VGG-16

You will pre-process each image with VGG-16 and cache the output to disk. Caching the output in RAM would be faster but also memory intensive, requiring 7 \* 7 \* 512 floats per image. At the time of writing, this exceeds the memory limitations of Colab (currently 12GB of memory).
...
* In this example, you extract the features from the lower convolutional layer of VGG_16 giving us a vector of shape (7, 7, 512).
* You squash that to a shape of (49, 512).
