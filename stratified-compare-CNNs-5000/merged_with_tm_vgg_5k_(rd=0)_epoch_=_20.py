# -*- coding: utf-8 -*-
"""Merged - With TM - VGG - 5k (rd=0) epoch = 20.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nwKSsryB-WOvLY0tby4cNegXDPLkcsvZ
...
You will pre-process each image with VGG-16 and cache the output to disk. Caching the output in RAM would be faster but also memory intensive, requiring 7*87*512 floats per image. 
