# -*- coding: utf-8 -*-
"""Merged- With TM - Inception - 5k (rd=0) - epoch = 30.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Hpp2yRFrplih2LBirAwCyzYL3nMqRiBJ
...
# Save bleus, prediction
from google.colab import files
pd.DataFrame(pred).to_csv('merged-pred 5000 30epoch.csv')
files.download('merged-pred 5000 30epoch.csv')

from google.colab import files
pd.DataFrame(bleus).to_csv('merged-bleus 5000 30epoch.csv')
files.download('merged-bleus 5000 30epoch.csv')
