# -*- coding: utf-8 -*-
"""Without TM - Inception - 13k.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1yWMw_ADLcFlCZh3Ld3yZeDe6GfydV1j2
...
pd.DataFrame(bleus).to_csv('withoutTM-bleus 13000.csv')
files.download('withoutTM-bleus 13000.csv')

pd.DataFrame(pred).to_csv('withoutTM-pred 13000.csv')
files.download('withoutTM-pred 13000.csv')
