# -*- coding: utf-8 -*-
"""Without TM - Inception - 9k.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CzMLmAzuPAc3GqR5wqQ7WdhSn31k6d_u
...
pd.DataFrame(bleus).to_csv('withoutTM-bleus 9000.csv')
files.download('withoutTM-bleus 9000.csv')

pd.DataFrame(pred).to_csv('withoutTM-pred 9000.csv')
files.download('withoutTM-pred 9000.csv')
